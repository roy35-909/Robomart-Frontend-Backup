  ...
  return (
    <Container maxWidth={"lg"} style={{ padding: "5vh 0" }}>
      ...
      <Typography paragraph>
        ...
        sealed packages will not be considered Unaffected if the seal is opened
      ...
      <Typography paragraph>
        Orders will be shipped to the purchasers designated address, provided it
        is accessible and within the political borders of Bangladesh. The risk
        of loss of purchased items transfers to the customer upon delivery to
        the carrier. Customers are responsible for initiating claims for damaged
        or lost shipments.
      </Typography>
      ...
      <Typography paragraph>
        ...
        modified or removed without notice. It is the customers responsibility
      ...
      <Typography paragraph>
        ...
        external sites. Use of third-party links is at the users own risk.
      </Typography>
      <Typography fontWeight={"bold"} variant="h5" gutterBottom>
      ...
      <Typography paragraph>
        The information, materials, and services on this website are provided as
        is without warranties. Robomart Bd does not warrant the accuracy or
